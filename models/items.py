...
# mail module
class Mail(pw.Model):
    id = pw.IntegerField(verbose_name="mail id", primary_key=True)
    ...
    sender_id = pw.IntegerField(verbose_name="mail sender id", default=None)
    receiver_id = pw.IntegerField(verbose_name="mail receiver id", default=None)
